              ...
              return (
                <div key={code} className={index > 0 ? 'border-t border-white/8 pt-5 mt-5' : ''}>
                  ...
                  >
                    ...
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" className="ml-auto shrink-0 text-gray-500 transition group-hover:translate-x-0.5 group-hover:text-gray-300">
