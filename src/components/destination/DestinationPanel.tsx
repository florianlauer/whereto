...
export function DestinationPanel({
  ...
  return (
    ...
    >
      ...
      {match && (
        <div
          className={`h-[2px] w-full ${match.dot.replace("bg-", "bg-")} opacity-80`}
          style={{
            background: match.dot.includes("green")
              ? "linear-gradient(90deg, #22c55e, transparent)"
              : match.dot.includes("yellow")
      ...
      <div className="flex items-start justify-between px-6 pt-5 pb-4">
        <div className="flex-1 min-w-0">
          ...
          {match && (
            <div
              className={`mt-2 inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 ${match.border}`}
            >
        ...
        <div className="h-full overflow-y-auto px-6 pb-4 scrollbar-none">
            ...
            <StatRow
              ...
              value={
                <span
                  ...
                  role="img"
                  aria-label={`Sécurité ${country.safetyScore} sur 5`}
                >
          ...
          {onCompare && (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p
                    className={`text-sm font-medium ${isInComparison ? "text-blue-300" : "text-white"}`}
                  >
              ...
              <svg
                ...
                viewBox="0 0 16 16"
                fill="none"
                className={`transition-transform group-hover:translate-x-0.5 ${isInComparison ? "text-blue-400" : "text-gray-600 group-hover:text-gray-400"}`}
              >
                <path
                  d="M6 3l5 5-5 5"
                  stroke="currentColor"
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 16 16"
              fill="none"
              className="text-gray-600 transition-transform group-hover:translate-x-0.5 group-hover:text-gray-400"
            >
              <path
                d="M6 3l5 5-5 5"
                stroke="currentColor"
      ...
      <WishlistCounter onClear={clearWishlist} onOpen={() => onOpenTripSummary?.()} />
