  ...
  return (
    ...
    >
                ...
                <div key={code}>
                  ...
                  <div className="mb-3 rounded-lg bg-white/[0.03] px-3 py-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-gray-400">{budgetMin}€–{budgetMax}€</span>
                    </div>
                  </div>
                  ...
                  >
                    <span className="text-sm text-gray-500 transition group-hover:text-gray-300">✈</span>
                    <span className="text-xs text-gray-500 transition group-hover:text-gray-300">Voir les vols</span>
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" className="ml-auto text-gray-700 transition group-hover:text-gray-500">
      ...
      <div className="flex items-center justify-between border-t border-white/8 px-6 py-3">
        ...
        <button
          onClick={() => { clearWishlist(); handleClose() }}
...
export function WishlistCounter({ onClear, onOpen }: Props) {
  ...
  return (
    <div className="flex items-center justify-between border-t border-white/8 px-6 py-3">
      ...
      >
        <span className="text-sm">🧳</span>
        <span className="text-sm font-medium text-white underline-offset-2 hover:underline">{label}</span>
      </button>
      <button
        onClick={onClear}
